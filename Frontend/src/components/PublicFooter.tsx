...
export function PublicFooter() {
  ...
  return (
    <footer className="border-t border-border bg-background">
      <div className="max-w-content mx-auto px-6 py-12 flex flex-col sm:flex-row items-center justify-between gap-6">
      ...
      <div className="border-t border-border">
        <div className="max-w-content mx-auto px-6 py-5 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-muted-foreground">
