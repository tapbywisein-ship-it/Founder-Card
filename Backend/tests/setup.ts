...
process.env.DATABASE_URL = process.env.TEST_DATABASE_URL ?? 'postgresql://postgres:postgres@localhost:5432/tapbywisein_test';
...
process.env.EMAIL_FROM = 'test@tapbywisein.com';
