...
router.get('/public/slug/:slug', optionalAuthenticate, founderCardsController.getPublicCardBySlug.bind(founderCardsController));
router.get('/public/user/:userId', optionalAuthenticate, founderCardsController.getPublicCardByUserId.bind(founderCardsController));
router.get('/public/by-username/:username', optionalAuthenticate, founderCardsController.getPublicCardByUsername.bind(founderCardsController));
...
router.post('/me/nfc', authenticate, founderCardsController.provisionNfc.bind(founderCardsController));
